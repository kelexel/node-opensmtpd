...
Renderer.renderDocumentField = function(models, field, fields, options, document, isChild, parentFieldName) {
    ...
    var fieldValue = '';
    var fieldName = '';
    console.log(field, isChild);
    if (isChild) {
//        console.log('doc is child: ', document);
//        console.log('parentFieldName: ', parentFieldName);
//        console.log('field: ', field);
        // this can't handle multi-nested elements. just skip for now.
        try {
          ...
          console.log('Caught render error, skipping:', e);
          return; //?
        }
...
// console.log(fields[field].type.toString())
    ...
    } else if (fields[field].type === mongoose.Schema.Objectid) {   
    ...
    // } else if (fields[field].type.toString() == 'object') {
        ...
        // });
        var modelSelect = $('<input />').addClass('linked_model').attr('id', fieldName + '_linked_model').attr('name', fieldName + '_linked_model').attr('rel', fieldName + '_linked_document').attr('value', false);
