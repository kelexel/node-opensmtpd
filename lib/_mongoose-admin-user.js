...
MongooseAdminUser = prime ({
	...
	fromSessionStore: function(sessionStore) {
	...
	ensureExists: function(username, password, onReady) {
		var adminUser = new MongooseAdminUser();
	...
	getByUsernamePassword: function(username, password, onReady) {
		var adminUser = new MongooseAdminUser();
		var adminUserModel = mongoose.model('_MongooseAdminUser');
...
module.exports = MongooseAdminUser;
